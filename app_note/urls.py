...
from .views import NoteListView, NoteDetailView, NoteUpdateView, NoteCreateView, NoteDeleteView, NoteSearchView, AboutView
...
urlpatterns = [
    ...
    path('note/about/', AboutView.as_view(), name='note_about'),
